...
public class MySQLBaseTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			sql = "CREATE TABLE users(" + "user_id VARCHAR(255) NOT NULL," + "password VARCHAR(255),"
			...
			sql = "INSERT INTO users VALUES('1111', '3229c1097c00d49a0fd282d586be050', 'John', 'Smith')";
			statement.executeUpdate(sql);
